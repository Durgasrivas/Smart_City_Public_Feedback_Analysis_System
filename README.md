...
[!\[Gemini](https://img.shields.io/badge/Gemini-1.5\_Flash-4285F4?style=for-the-badge\&logo=google\&logoColor=white)](https://aistudio.google.com)
...
```bash
cp .env.example .env
# Add GEMINI\_API\_KEY=your\_key  ← free at aistudio.google.com
```
...
│
├── src/
│   ├── data\_collector.py     # Multi-source + synthetic data
│   ├── preprocessor.py       # Text cleaning + normalization
│   ├── sentiment\_analyzer.py # BERT sentiment (+ fallback)
│   ├── topic\_modeler.py      # BERTopic + LDA
│   ├── ner\_extractor.py      # Named Entity Recognition
│   ├── priority\_scorer.py    # Urgency scoring + alerts
│   ├── llm\_reporter.py       # Gemini report + chatbot
│   └── fine\_tuner.py         # BERT fine-tuning script
│
├── notebooks/
│   └── EDA\_and\_Analysis.ipynb  # 36-cell analysis notebook
│
└── data/
    ├── raw/
    └── processed/
...
4. Add secret: `GEMINI\_API\_KEY = "your\_key"`
5. Click **Deploy** ✅
...
3. Add `GEMINI\_API\_KEY` in Space secrets
